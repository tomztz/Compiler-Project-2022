...
class Lexer {
  ...
  private static final String ZZ_CMAP_PACKED = 
    ...
    "\1\10\1\0\1\6\5\0\1\5\4\0\1\4\1\7\11\7\3\0"+
    "\1\11\3\0\32\6\1\0\1\12\2\0\1\6\1\0\15\6\1\14"+
    "\3\6\1\15\1\6\1\13\6\6\4\0\41\7\2\0\4\6\4\0"+
    ...
    "\1\0\2\7\1\0\1\7\10\0\33\6\5\0\3\6\15\0\6\7"+
    ...
    "\1\0\10\6\26\0\60\7\66\6\3\7\1\6\22\7\1\6\7\7"+
    ...
    "\4\0\3\7\1\0\6\6\4\0\2\6\2\0\26\6\1\0\7\6"+
    ...
    "\6\0\1\7\16\0\12\7\11\0\1\6\6\0\4\7\1\0\10\6"+
    ...
    "\6\0\130\6\10\0\5\6\2\7\42\6\1\7\1\6\5\0\106\6"+
    ...
    "\14\0\44\6\24\7\10\0\12\7\3\0\3\6\12\7\44\6\2\0"+
    "\11\6\107\0\3\7\1\0\25\7\4\6\1\7\4\6\3\7\2\6"+
    "\3\7\6\0\300\6\72\7\1\0\5\7\u0116\6\2\0\6\6\2\0"+
  ...
  private static final String ZZ_ACTION_PACKED_0 =
    ...
    "\1\7\1\10\1\2\1\0\1\11\1\12\1\13\1\14"+
    "\3\0\1\2";
  ...
  private static final String ZZ_ROWMAP_PACKED_0 =
    "\0\0\0\16\0\34\0\52\0\34\0\70\0\106\0\34"+
    "\0\34\0\124\0\34\0\142\0\160\0\176\0\34\0\34"+
    "\0\34\0\34\0\214\0\232\0\250\0\214";
  ...
  private static final String ZZ_TRANS_PACKED_0 =
    ...
    "\1\11\1\3\3\7\1\12\2\3\5\12\1\13\1\12"+
    "\1\14\3\12\20\0\1\5\17\0\1\15\1\16\16\0"+
    "\2\7\3\0\3\7\1\12\2\0\5\12\1\0\1\12"+
    "\1\0\3\12\10\0\1\17\2\0\1\20\1\21\1\22"+
    "\1\15\1\4\1\5\13\15\5\23\1\24\15\23\1\25"+
    "\14\23\1\26\1\25\14\23\1\5\1\25\10\23";
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1: 
            ...
            System.out.println("action [65] { throw new Error(\"Illegal character <\"+"+ZZ_NL+"                                                yytext()+\">\"); }");
          ...
          case 4: 
            System.out.println("match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [39] { stringBuffer.setLength(0); yybegin(STRING); }");
          ...
          case 6: 
            System.out.println("match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [55] { stringBuffer.append( yytext() ); }");
          ...
          case 7: 
            System.out.println("match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [52] { yybegin(YYINITIAL);"+ZZ_NL+"                               return new Yytoken(SymbolTable.STRING_LITERAL,"+ZZ_NL+"                               stringBuffer.toString()); }");
            { yybegin(YYINITIAL);
          ...
          case 8: 
            System.out.println("match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [61] { stringBuffer.append(\'\\\\\'); }");
            { stringBuffer.append('\\');
            } 
            // fall through
          case 20: break;
          case 9: 
            System.out.println("match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [60] { stringBuffer.append(\'\\\"\'); }");
            { stringBuffer.append('\"');
            } 
            // fall through
          case 21: break;
          case 10: 
            System.out.println("match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [56] { stringBuffer.append(\'\\t\'); }");
            { stringBuffer.append('\t');
            } 
            // fall through
          case 22: break;
          case 11: 
            System.out.println("match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [57] { stringBuffer.append(\'\\n\'); }");
            { stringBuffer.append('\n');
            } 
            // fall through
          case 23: break;
          case 12: 
            System.out.println("match: --"+zzToPrintable(yytext())+"--");
            System.out.println("action [59] { stringBuffer.append(\'\\r\'); }");
